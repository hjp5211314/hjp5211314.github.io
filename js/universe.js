/**
 * Universe - Starry Sky with Meteor Effect
 */
function dark() {
  ...
  (function t() {
    ...
    const isDark = htmlElement ? htmlElement.getAttribute('data-theme') === 'dark' : false;
    
    if (isDark) {
      u(); // 绘制流星
    } else {
      h.clearRect(0, 0, n, e); // 清除画布
    }
    window.requestAnimationFrame(t);
  })();
}

// Check if universe canvas exists before running
